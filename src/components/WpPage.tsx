  ...
  return (
    <WpShell>
      ...
      {pageCss || product ? (
        <link
          rel="stylesheet"
          href={`/wp-mirror/css/page-styles/${slug}.css?v=renacon-why-renacon-recreation-202609171430`}
        />
      ) : null}
      ...
      {slug === "calculator" || product ? (
        <link
          rel="stylesheet"
          href="/wp-mirror/css/header-blocksy-in.css?v=renacon-homepage-recreation-202609171200"
        />
      ) : null}
      <WpMain html={html} />
    </WpShell>
