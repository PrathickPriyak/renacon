  ...
  return (
    <WpShell>
      ...
      {pageCss || product ? (
        <link
          rel="stylesheet"
          href={`/wp-mirror/css/page-styles/${slug}.css?v=renacon-about-us-exact-202609171110`}
        />
      ) : null}
      ...
      {slug === "calculator" || product ? (
        <link
          rel="stylesheet"
          href="/wp-mirror/css/header-blocksy-in.css?v=renacon-about-us-exact-202609171110"
        />
      ) : null}
      <WpMain html={html} />
    </WpShell>
