  ...
  return (
    <WpShell>
      ...
      {pageCss || product ? (
        <link
          rel="stylesheet"
          href={`/wp-mirror/css/page-styles/${slug}.css?v=renacon-why-renacon-exact-202609171215`}
        />
      ) : null}
      ...
      {slug === "calculator" || product ? (
        <link
          rel="stylesheet"
          href="/wp-mirror/css/header-blocksy-in.css?v=renacon-why-renacon-exact-202609171215"
        />
      ) : null}
      <WpMain html={html} />
    </WpShell>
