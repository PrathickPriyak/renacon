  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(endpoint, {
        ...
        body: JSON.stringify({ ...data, kind, product }),
      });
      ...
      setMessage(
        kind === "brochure"
          ? "Thank you. Your brochure request is recorded. Our team will share the datasheet."
          : kind === "careers"
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4">
      ...
      <textarea
        ...
        name="message"
        rows={4}
        placeholder={kind === "brochure" ? "Project / message" : "Message"}
      />
      <button
        type="submit"
