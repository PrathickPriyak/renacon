  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="stylesheet"
          href="/wp-mirror/css/site-overrides.css?v=renacon-animation-interactions-202609171530"
        />
        {/* eslint-disable-next-line @next/next/no-css-tags */}
        <link
          rel="stylesheet"
          href="/wp-mirror/css/header-blocksy-in.css?v=renacon-animation-interactions-202609171530"
        />
      </head>
      <body
