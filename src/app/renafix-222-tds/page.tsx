...
const product = getProduct("renafix-222-tile-adhesive");

export const metadata = { title: "Renafix 222 TDS" };
...
export default function Page() {
  ...
  return (
    <>
      <PageHero title="Renafix 222 TDS" subtitle="Installation guidance sourced from the official Renacon product pages." />
