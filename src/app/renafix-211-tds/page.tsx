...
export const metadata = { title: "Renafix 211 TDS" };
...
export default function Page() {
  ...
  return (
    <>
      <PageHero title="Renafix 211 TDS" subtitle="Installation guidance sourced from the official Renacon product pages." />
